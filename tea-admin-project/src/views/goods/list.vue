      ...
      <el-form :inline="true" :model="searchForm" class="form-inline">
        ...
        <el-form-item label="商品分类">
          <el-select v-model="searchForm.category" placeholder="请选择分类">
            ...
            <el-option label="花茶" value="花茶"></el-option>
...
export default {
  ...
  methods: {
    ...
    handleEdit(row) {
      ...
      this.goodsForm = { ...row };
      this.goodsForm.goods_price = row.price;
      this.dialogVisible = true;
    },
    ...
    async handleBatchDelete() {
      try {
        await this.$confirm(
          `确认删除选中的 ${this.selectedItems.length} 个商品吗？`,
          '提示',
          {
            type: 'warning',
          }
    ...
    handleUploadSuccess(res) {
      console.log(res, 'res');
      this.goodsForm.goods_imgUrl = res.data.img_url;
    },
    async submitForm() {
      try {
