    ...
    <el-card class="order-list" shadow="never">
      <div slot="header" class="card-header">
        ...
        <div class="header-operations">
          <el-button type="primary" size="small" @click="exportOrders">导出订单</el-button>
          <el-button type="success" size="small" @click="batchShip">批量发货</el-button>
        </div>
      </div>
        ...
        <el-table-column label="商品信息" min-width="400">
          <template slot-scope="{row}">
            <div class="goods-list">
              <div v-for="(goods, index) in row.goodsList" :key="index" class="goods-item">
                <el-image 
                  :src="goods.image" 
